...
import gg.bayes.challenge.service.LogService;
...
public class MatchController {
    ...
    public ResponseEntity<Long> ingestCombatLog(@RequestBody @NotBlank String combatLog) {
        return new ResponseEntity<>(logService.writeLog(combatLog), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<List<HeroItem>> getHeroItems(
        ...
        return new ResponseEntity<>(matchRepository.findHeroItemsByMatch(matchId, heroName), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<HeroDamage>> getHeroDamages(
            @PathVariable("matchId") Long matchId,
            @PathVariable("heroName") String heroName) {
        return new ResponseEntity<>(matchRepository.findHeroDamageByMatch(matchId, heroName), HttpStatus.OK);
    }
}
